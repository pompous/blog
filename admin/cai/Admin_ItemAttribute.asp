...
<span class="note">如果不分页请保持为0</span></td>
    ...
    <tr>
      ...
      <td class="b1_1">
        <input name="Script_Iframe" type="checkbox" class="noborder" value="yes" checked <%If Script_Iframe=-1 Then response.write "checked"%>>
        Iframe
        <input name="Script_Object" type="checkbox" class="noborder" onclick='return confirm("确定要选择该标记吗？这将删除正文中的所有Object标记，结果将导致该文章中的所有Flash动画被删除！");' value="yes" <%If Script_Object=-1 Then response.write "checked"%>>
        Object
        <input name="Script_Script" type="checkbox" class="noborder" value="yes" checked <%If Script_Script=-1 Then response.write "checked"%>>
        Script
        <input name="Script_Div" type="checkbox" class="noborder"  value="yes" checked <%If Script_Div=-1 Then response.write "checked"%>>
        Div
        <input name="Script_Class" type="checkbox" class="noborder"  value="yes" <%If Script_Class=-1 Then response.write "checked"%>>
        Class
        <input name="Script_Table" type="checkbox" class="noborder"  value="yes" checked <%If Script_Table=-1 Then response.write "checked"%>>
        Table
        <input name="Script_Tr" type="checkbox" class="noborder"  value="yes" checked <%If Script_Tr=-1 Then response.write "checked"%>>
        Tr
        <br>
        ...
        Font&nbsp;&nbsp;
        <input name="Script_A" type="checkbox" class="noborder" value="yes" checked <%If Script_A=-1 Then response.write "checked"%>>
        A&nbsp;&nbsp;
        ...
        Html&nbsp;
        <input name="Script_Td" type="checkbox" class="noborder"  value="yes" checked <%If Script_Td=-1 Then response.write "checked"%>>
        Td&nbsp;&nbsp;&nbsp;
		<input name="Script_Tbody" type="checkbox" class="noborder"  value="yes" checked <%If Script_Tbody=-1 Then response.write "checked"%>>
        Tbody</td>
    </tr>
    <tr>
